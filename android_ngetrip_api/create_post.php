...
if (isset($_POST['kriteria_postingan']) && isset($_POST['title']) && isset($_POST['description']) && isset($_POST['created_by']) && isset($_POST['daerah_asal']) && isset($_POST['daerah_tujuan']) && isset($_POST['jumlah_orang'])) {
    ...
    // receiving the post params
       ...
       // create a new user
    $post = $db->create_post($kriteria_postingan, $title, $description, $created_by, $daerah_asal, $daerah_tujuan, $jumlah_orang);
