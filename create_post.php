...
if (isset($_POST['kriteria_postingan']) && isset($_POST['title']) && isset($_POST['description']) && isset($_POST['created_by']) && isset($_POST['daerah_asal']) && isset($_POST['daerah_tujuan']) && isset($_POST['jumlah_orang']) && isset($_POST['url_gambar']) && isset($_POST['tanggal_berangkat']) && isset($_POST['tanggal_selesai'])) {
    ...
    // receiving the post params
        ...
        // die("".$tanggal_berangkat.$tanggal_selesai);
        
       // create a new user
    $post = $db->create_post($kriteria_postingan, $title, $description, $created_by, $daerah_asal, $daerah_tujuan, $jumlah_orang, $url_gambar, $tanggal_berangkat, $tanggal_selesai);
