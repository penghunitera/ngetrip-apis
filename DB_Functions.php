...
class DB_Functions {
    ...
    public function create_post($kriteria_postingan, $title, $description, $created_by, $daerah_asal, $daerah_tujuan, $jumlah_orang, $url_gambar, $tanggal_berangkat, $tanggal_selesai) {

        $uuid = uniqid('', true);

        $stmt = $this->conn->prepare("INSERT INTO ngetrip_post(kriteria_postingan, title, description, created_by, created_at, daerah_asal, daerah_tujuan, jumlah_orang, uid, tanggal_berangkat, tanggal_selesai) VALUES(?, ?, ?, ?, NOW(), ?, ?, ?, ?, ?, ?)");

        $stmt->bind_param("issississs", $kriteria_postingan, $title, $description, $created_by, $daerah_asal, $daerah_tujuan, $jumlah_orang, $uuid, $tanggal_berangkat, $tanggal_selesai);
    ...
    public function acceptpermintaanjoin($userid, $postid) {
    ...
    public function rejectpermintaanjoin($userid, $postid) {

        $stmt = $this->conn->prepare("UPDATE ngetrip_tripmember SET status = 3 WHERE post_id=".$postid." and user_id=".$userid);
        // $stmt->bind_param("ii", $userid, $postid);
